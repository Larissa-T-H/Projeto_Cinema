...
namespace Cinema.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmeId,Titulo,Sinopse")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmeId,Titulo,Sinopse")] Filme filme)
        {
            if (id != filme.FilmeId)
            {
                return NotFound();
